        ...
        <div className="mt-5">
          <div className="w-full px-1 md:px-4 space-x-4 flex items-center">
            ...
            <Link
              target="_blank"
              className="docs_link"
              href={`https://mumbai.polygonscan.com/address/${managerAddress}`}
            >{`${managerAddress.slice(0, 7)}...${managerAddress.slice(
              -4
            )} - Manager Contract`}</Link>
          </div>
          <div className="w-full px-1 md:px-4 space-x-4 flex items-center mt-2">
            <div className="w-8">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                <path
                  d="M64 0c35.348 0 64 28.652 64 64s-28.652 64-64 64S0 99.348 0 64 28.652 0 64 0zm0 0"
            ...
            <Link
              target="_blank"
              className="docs_link"
              href={`https://mumbai.polygonscan.com/address/${levelAddress}`}
            >{`${levelAddress.slice(0, 7)}...${levelAddress.slice(
              -4
            )} - NFT Contract`}</Link>
          </div>
        </div>
